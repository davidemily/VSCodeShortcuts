...
<table>
    ...
    <tr>
        <td>Ctrl+ 1 / 2 / 3</td>
        <td>Focus into 1st, 2ndor 3rd Editor Group</td>
    </tr>
    <tr>
        <td>Ctrl+K Ctrl+←/→</td>
        <td>Focus into previous/nexteditor group</td>
    </tr>
    <tr>
        <td>Ctrl+Shift+PgUp/PgDnMove </td>
        <td>Editor Left/Right</td>
    </tr>
    <tr>
        <td>Ctrl+K ←/→</td>
